...
if __name__ == '__main__':
    postfix = 'jpg'
    img_path = '/home/fan/yolov8/road/images'
    label_path = '/home/fan/yolov8/road/labels'
    predict_path = '/home/fan/yolov8/runs/detect/output/labels'
    save_path = '/home/fan/yolov8/res/'
    ...
    detect_color, missing_color, error_color  = (0, 255, 0),  (255, 0, 0),(0, 0, 255)
    iou_threshold = 0.9
    ...
    with open('result.txt', 'w') as f_w:
        for path in tqdm.tqdm(os.listdir(predict_path)):
